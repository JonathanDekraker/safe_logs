...
export default function NewSanitationTaskScreen() {
  const router = useRouter();
  const { addSanitationTask } = useAppStore();
  ...
  const handleSubmit = () => {
    ...
    const newTask: Omit<SanitationTask, 'id' | 'lastCompleted' | 'nextDue'> = {
      name: name.trim(),
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'New Sanitation Task' }} />
